# Set variables
$zipUrl = "https://github.com/MarkW-WTI/RMMScripts/raw/refs/heads/main/O365%20-%20x64%20nl-NL.zip"
$tempPath = "C:\temp"
$zipFile = "$tempPath\O365.zip"
$scriptFolder = "$tempPath\O365 - x64 nl-NL"
$scriptToRun = "$scriptFolder\installO365x64NL.ps1"
